...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=schmidtw_goschtalt&metric=alert_status)](https://sonarcloud.io/dashboard?id=schmidtw_goschtalt)
